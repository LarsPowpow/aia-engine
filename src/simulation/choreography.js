...
// Based on: The "Mid-Combo Block" PvP Combat Choreography (v4.0 - Explicit Weapon Swap)
...
export const midComboBlockChoreography = [
  ...
  // --- UPGRADE: Explicitly define the target weapon for the swap ---
  { timestamp: 6.25, action: 'WEAPON_SWAP', targetWeapon: 'Sword', notes: 'Weapon Swap to Sword' },
