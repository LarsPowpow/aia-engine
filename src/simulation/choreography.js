...
export const midComboBlockChoreography = [
  ...
  { timestamp: 7.25, action: 'ABILITY', abilityId: 'ability_sword_rush', weapon: 'Sword', sourceId: 'Player', targetId: 'Target Dummy', notes: 'Shield Rush' },
  { timestamp: 8.4, action: 'HEAVY_ATTACK', weapon: 'Sword', sourceId: 'Player', targetId: 'Target Dummy', notes: 'Heavy Attack' },
  { timestamp: 9.55, action: 'ABILITY', abilityId: 'ability_sword_whirlingblade', weapon: 'Sword', sourceId: 'Player', targetId: 'Target Dummy', notes: 'Whirling Blade' },
