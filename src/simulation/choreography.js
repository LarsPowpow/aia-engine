...
export const midComboBlockChoreography = [
  ...
  { timestamp: 4.92, action: 'ABILITY_HIT', abilityId: 'ability_flail_arcane_eruption', weapon: 'Flail', baseDamageMultiplier: 1.50, hitCount: 2, sourceId: 'Player', targetId: 'Target Dummy', notes: 'Arcane Eruption Hit 2 (150% Physical + Extend + Heal)' },
  { timestamp: 5.75, action: 'ABILITY_HIT', abilityId: 'ability_flail_blast', weapon: 'Flail', damageType: 'ARCANE', baseDamageMultiplier: 0.75, hitCount: 1, sourceId: 'Player', targetId: 'Target Dummy', notes: 'Arcane Vortex Hit 1' },
