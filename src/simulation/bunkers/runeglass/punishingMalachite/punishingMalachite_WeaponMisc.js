/**
 * @file punishingMalachite_WeaponMisc.js
 * @description Factory bunker for Punishing Malachite (Weapon): +2% melee damage (always on).
 */
...
export const METADATA = {
    ...templateMetadata,
    id: 'runeglass_malachite_weapon_misc',
    type: 'RUNEGLASS',
    label: 'Runeglass of Punishing Malachite (Weapon)',
    description: 'Weapon Socket: Your melee attacks deal +2% damage while this weapon is equipped.',
    amount: 0.02,
    eventType: 'PASSIVE',
